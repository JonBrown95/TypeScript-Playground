...
describe(Parrot, () => {
    ...
    describe("speak", () => {
        ...
        ])("speaks the only known phrase when the random number is %f", (randomValue, expected) => {
        ...
        ])("speaks phrase $index of $phrases.length when the seed is $seed", ({ phrase, phrases, seed, }) => {
